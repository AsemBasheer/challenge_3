            ...
            this.state.page === "form1" ?
                <div className="d-flex justify-content-center align-items-center vh-100">
                    <div className="w-50">
                        ...
                        <button className="m-1 w3-button w3-red" onClick={() => { this.postData("form1"), this.setState({ page: "form2" }) }}>next</button>
                </div>
                :
                    ...
                    <div className="d-flex justify-content-center align-items-center vh-100">
                        <div className="w-50">
                            <form>
                                ...
                                <button className="m-1 w3-button w3-red" onClick={() => { this.postData("form2"), this.setState({ page: "form3" }) }}>next</button>
                    </div>
                    :
                    this.state.page === "form3" ?
                        <div className="d-flex justify-content-center align-items-center vh-100">
                            <div className="w-50">
                                ...
                                <button className="m-1 w3-button w3-red" onClick={() => { this.postData("form3"), this.setState({ page: "form4" }) }}>next</button>
                        </div>
                        :
                        this.state.page === "form4" ?
                            <div className="d-flex justify-content-center align-items-center vh-100">
                                <div className="w-50">
                                    ...
                                    <button className="m-1 w3-button w3-red" onClick={() => { this.reset(), this.setState({ page: "home" }) }}>Purchase</button>
                                </div>
                            </div>
                            :
                            <div className="d-flex justify-content-center align-items-center vh-100">
                                <img src="https://miro.medium.com/max/1200/1*Eyt1T-FH2FSo2e1syR8ubQ.png" width="700rem"></img>
                                <button className="m-1 w3-button w3-red" onClick={() => { this.setState({ page: "form1" }) }}>Checkout</button>
                            </div>
        )
    }
}
